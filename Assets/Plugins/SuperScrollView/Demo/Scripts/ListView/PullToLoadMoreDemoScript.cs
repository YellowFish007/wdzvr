...
namespace SuperScrollView
{
    public class PullToLoadMoreDemoScript : MonoBehaviour
    {
        ...
        {
            Debug.Log("LoopListViewItem2 OnGetItemByIndex : " + index);
            ...
            if (index == DataSourceMgr.Get.TotalItemCount)
            {
                ...
                Debug.Log("LoopListViewItem2 OnGetItemByIndex");
        ...
        void OnDraging()
        {
            ...
            Debug.Log("DataSourceMgr.Get.TotalItemCount" + DataSourceMgr.Get.TotalItemCount);
            ...
            Debug.Log("y : " + y + "mLoopListView.ViewPortSize" + mLoopListView.ViewPortSize + " plus " + (y + mLoopListView.ViewPortSize) );
