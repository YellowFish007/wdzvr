...
namespace Engine
{
    ...
    public class GameEvent
    {
        ...
        public static void AddEventListener<T1, T2>(T2 v, object onUIMessageData)
        {
        ...
        public static void AddEventListener(string v, Action<int> onUILoginAccountItemToggle)
        {
            throw new NotImplementedException();
        }
